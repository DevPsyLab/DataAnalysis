...
1. Create a Personal Access Token (https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html or https://research-git.uiowa.edu/-/profile/personal_access_tokens) on the UI GitLab instance (https://research-git.uiowa.edu) to access UI GitLab repositories from GitHub Desktop.
...
https://github.blog/2015-01-14-partial-commits-in-github-for-windows
