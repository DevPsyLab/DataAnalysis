...
## Linear Growth Curve Model {#linearLGCM}
...
## Latent Basis Growth Curve Model {#latentBasisLGCM}
...
For a list of tools to create path diagrams, see [here](figures.qmd#pathDiagrams).
