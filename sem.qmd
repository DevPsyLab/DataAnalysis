...
- local structural-after-measurement (SAM) (for papers, see [here](https://doi.org/10.3758/s13428-024-02532-y) and [here](https://doi.org/10.31234/osf.io/xk8um_v3)—the paper has since been accepted for publication in *Psychological Methods*)
...
round(cbind(
  model1 = inspect(model1, "fit.measures"), 
