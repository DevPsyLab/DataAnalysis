...
- [`powRICLPM` `R` package](https://cran.r-project.org/web/packages/powRICLPM/index.html) for random-intercepts cross-lagged panel models (based on [Mulder, 2023](https://doi.org/10.1080/10705511.2022.2122467); see vignettes [here](https://jeroendmulder.github.io/powRICLPM/articles/start.html))
