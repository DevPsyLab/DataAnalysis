...
- Evaluate the semi-automated pipeline from [Desjardins et al. (2021)](https://www.sciencedirect.com/science/article/pii/S0165027020303848); [Haresign et al (2021)](https://www.sciencedirect.com/science/article/pii/S1878929321001146); [Flo et al. 2022](https://www.sciencedirect.com/science/article/pii/S1878929322000214?via%3Dihub)
...
1. Artifact Rejection
    ...
    1. Manual selection and removal of bad channels
    1. Manual selection and removal of bad time periods
    1. [Independent Component Analysis](#ica) (ICA)
        1. Automated removal of ICA components
        1. Re-run ICA
        1. Manual removal of ICA components
