...
## Oddball Task
1. User Inputs
    * Enter the path to the folder containing the dataset. All ERP files are stored on the lab drive (`\\lc-rs-store24.hpc.uiowa.edu\lss_itpetersen\Lab\Studies\School Readiness Study\Data\LV2\ERP`)
    * Select "raw"
