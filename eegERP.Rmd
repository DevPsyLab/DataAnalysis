...
These are tips that have been helpful when running through the HAPPE pipeline.

1. Download the HAPPE pipeline to your local computeer from the [HAPPE repo](https://github.com/PINE-Lab/HAPPE).
1. Open MATLAB and read throughtthe entire user guide. 
Currently, we are using the HAPPE+ER pipeline.
