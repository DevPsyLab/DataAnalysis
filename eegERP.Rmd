...
Go to `Window` and input the following:
    ...
    - select among `mean`, `maxPeak`, or other options
      (According to Joe Dien), all the different methods result in comparable *p*-values when dealing with PCA components (however, they do not give the results when windowing the raw waveforms), so select a method that makes sense for the story you want to tell
