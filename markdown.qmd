...
To use the lab templates for the "Prepare Data" and "Computational Notebook" scripts, first install the [`petersenlab` package](R.qmd#petersenlab).
...
If the heading is on a different page of the same wiki, specify the html file before the label, e.g.: `[text to show](dataManagement.qmd#saveData)`.
...
[I am a link to another file in this project](pca.qmd#overview)
...
Follow the instructions [here](git.qmd#gitLfs) to do so.
