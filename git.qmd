...
For information on how to set up and use `git` and `GitHub Desktop`, see Section \@ref(sec-howToUseGit).
...
1. Drag the repo  folder to the `GitHub Desktop` app (the repo folder should contain a `.git` folder as a subfolder)
