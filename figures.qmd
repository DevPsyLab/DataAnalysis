...
histX + patchwork::plot_spacer() + scatterplot + histY + 
  patchwork::plot_layout(
    ncol = 2, 
    nrow = 2, 
    widths = c(4, 1),
...
boxX + patchwork::plot_spacer() + scatterplot + boxY + 
  patchwork::plot_layout(
    ncol = 2, 
    nrow = 2, 
    widths = c(4, 1),
...
violinX + patchwork::plot_spacer() + scatterplot + violinY + 
  patchwork::plot_layout(
    ncol = 2, 
    nrow = 2, 
    widths = c(4, 1),
...
densHistX + patchwork::plot_spacer() + scatterplot + densHistY + 
  patchwork::plot_layout(
    ncol = 2, 
    nrow = 2, 
    widths = c(4, 1),
