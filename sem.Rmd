...
coef(lgcm1_fit)["intercept~1"]
coef(lgcm1_fit)["slope~1"]
...
newData$predictedValue[which(newData$time == 1)] <- coef(lgcm1_fit)["intercept~1"]
newData$predictedValue[which(newData$time == 4)] <- coef(lgcm1_fit)["intercept~1"] + timepoints*coef(lgcm1_fit)["slope~1"]
...
newData$t4 <- newData$intercept + timepoints*newData$slope
