...
# Data Security Protocols {#sec-dataSecurityProtocols}
...
# Accessing ABCD Data {#sec-accessingABCDdata}

## Step 1: Data Use Certificate {#sec-dataUseCertificate}

Work with Dr. Petersen to get added to the Data Use Certificate.

## Step 2: Read (and Follow) the Lab's Protocols for Handling ABCD Data {#sec-labProtocols}

1. Read and follow the lab's [Data Security Protocols](#sec-dataSecurityProtocols) outlined above for handling ABCD data.
...
## Step 3: Connect to the Research Remote Desktop Service (RRDS) {#sec-connectRRDS}
...
## Step 4: Connect to the ABCD LSS Server {#sec-connectLSS}
...
## Access Management {#sec-accessManagement}
...
# LSS Structure {#sec-lssStructure}
...
## Analyses Projects {#sec-analysesProjects}
...
`Analyses Projects > PetersenLab` contains user folders for anyone working on projects with the ABCD data.
  ...
  1. Follow the version control instructions [below](#sec-versionControl)
...
## Available Measures {#sec-availableMeasures}
