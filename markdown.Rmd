...
- [`Posit (Formerly RStudio)`](https://www.rstudio.com)
...
You should have two computational notebooks: 1) a "Prepare Data" script (`prepareData.Rmd`) and 2) a "Computational Notebook" script (`computationalNotebook.Rmd`).
