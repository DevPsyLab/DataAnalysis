...
- When adding a link, add both the original link and the [perma.cc](https://perma.cc) link to prevent link rot (websites will go offline and disappear over time).
...
# Video formatting for Wiki {#video}
