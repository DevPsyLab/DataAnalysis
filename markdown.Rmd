...
# `rmarkdown` Website using GitHub Actions {#website}
...
1. Switch back the main branch of the repo, and add the following contents (to the main branch, **not** to the `gh-pages` branch):
    - `/.github/workflows/deploy_markdown.yml` file
        ...
        - add the following contents to the file:
            - if the `rmarkdown` website is intended to be public: https://github.com/DevPsyLab/LabWiki/blob/main/.github/workflows/deploy_rmarkdown.yml
            - if the `rmarkdown` website is intended to be private: https://github.com/DevPsyLab/SchoolReadinessStudy/blob/main/.github/workflows/deploy_rmarkdown.yml
...
https://stackoverflow.com/a/75308228/2029527
...
This text <ins>will be underlined</ins>; this text <u>will also be underlined</u>.
...
# Embedding a html file within a markdown document {#html}
...
It is important to lower the quality of videos so that we do not exceed the 1gb file size limit on any given repo.
