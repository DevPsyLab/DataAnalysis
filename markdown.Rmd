...
1. Create the repository using one of the following templates:
    - `rmarkdown`: https://github.com/DevPsyLab/MarkdownWebsite
        - for local rendering: https://github.com/isaactpetersen/MarkdownWebsite-RenderLocal
    - `Quarto`: https://github.com/DevPsyLab/QuartoWebsite
        - for local rendering: (we have not created an exemplar yet)
    ...
    - `/.github/workflows/deploy_markdown.yml` file
        ...
        - add the following contents to the file:
            ...
            - if using `Quarto`:
                ...
                - if the website is intended to be private: (we have not created an exemplar yet)
