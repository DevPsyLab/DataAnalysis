...
Model without covariates—replace `outcome` with name of outcome variable, `predictor` with name of predictor variable, and `mediator` with name of mediating variable:
