...
If you are just trying to visualize the results of a SEM model fitted using the `lavaan` package, I recommend the [`semPlot`](https://doi.org/10.32614/CRAN.package.semPlot) or [`lavaanPlot`](https://doi.org/10.32614/CRAN.package.lavaanPlot) packages in `R`.
