...
mydata[which(mydata$parch >= 1),]
mydata[which(mydata$parch %in% c(0,1)),]
mydata[which(mydata$parch %ni% c(0,1)),]
mydata[which(is.na(mydata$prediction)),]
mydata[which(!is.na(mydata$prediction)),]
```
...
```{r}
mydata[c(1,3,5), c("survived","age","prediction")]
mydata[subsetRows, subsetVars]
mydata[which(mydata$survived == 1), subsetVars]
mydata[which(mydata$parch >= 1), subsetVars]
mydata[which(mydata$parch %in% c(0,1)), subsetVars]
mydata[which(mydata$parch %ni% c(0,1)), subsetVars]
mydata[which(is.na(mydata$prediction)), subsetVars]
mydata[which(!is.na(mydata$prediction)), subsetVars]
```
