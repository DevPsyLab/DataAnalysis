...
The keys are used to merge the variables in `object 1` with the variables in `object 2`.
...
To prevent this, either remove or rename the variable in one of the objects.
