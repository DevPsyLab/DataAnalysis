...
1. If installing `MATLAB`:
    1. Copy the dependencies file into your `containers` folder (get the dependencies path for the latest released version from here: <https://github.com/mathworks-ref-arch/container-images/tree/main/matlab-deps>; make sure to specify the correct architecture—i.e., AMD or ARM):
...
| `-q [UI\|UI-HM\|UI-MPI\|UI-GPU\|UI-DEVELOP\|all.q]` | which job [queue](#sec-queues) to use[^2]  |
