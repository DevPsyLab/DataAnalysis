...
To log in to the lab's LAMP server, use [`WinSCP`](https://winscp.net/eng/download.php) or [`SecureCRT`](https://its.uiowa.edu/services/securecrt).

Our LAMP domain is: `pbslamp.divms.uiowa.edu`

Our credentials are in our LastPass account.
You must be on the university network (or VPN) in order to connect to the server.
...
# Connecting participant IDs to SONA

You can find instructions to merge LAMP server cognitive tasks with SONA studies here: https://devpsylab.github.io/DataAnalysis/lamp.html