...
# 5. Then, build the package: Ctrl-Shift-B
devtools::build()

# 6. Then, check the package: Ctrl-Shift-E
devtools::check()

# 7. (Optional) If you want the PDF version of the manual:
devtools::build_manual()
```

8. Then, run [`R CMD check`](#sec-rCmdCheck)

9. Then, install the package:
