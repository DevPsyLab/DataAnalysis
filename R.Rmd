...
The `petersenlab` package is here: https://devpsylab.github.io/petersenlab.
...
After you have installed (and loaded) the [`petersenlab` package](#petersenlab), you can install (if not already installed) and load packages using the following command:

```{r, eval = FALSE}
load_or_install(c("name_of_package1","name_of_package2","name_of_package3"))
```
