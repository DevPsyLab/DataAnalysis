...
1. For [reproducibility purposes](#dontSaveWorkspace), prevent `R`/`RStudio` from saving the workspace.
...
For reproducibility purposes, it is important [**not** to save your workspace image](https://www.r-bloggers.com/2017/04/using-r-dont-save-your-workspace/).
