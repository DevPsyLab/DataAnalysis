...
This is problematic because those objects can interact/interfere withe the code and can lead to problems with replicability for others who are running the code without those objects in the workspace.
