...
1. Request an [API token](https://redcap.icts.uiowa.edu/redcap/api/help/?content=tokens) for the following REDCap projects:
...
For each data analysis project (i.e., each [GitHub](#git) repo), create an RStudio Project.
